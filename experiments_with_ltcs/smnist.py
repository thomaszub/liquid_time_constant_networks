...
class SMnistModel:
    ...
    def __init__(self,model_type,model_size,learning_rate = 0.001):
        ...
        self.x = tf.compat.v1.placeholder(dtype=tf.float32,shape=[28,None,28])
        self.target_y = tf.compat.v1.placeholder(dtype=tf.int32,shape=[None])
        ...
        head = unstack_head[-1]
        self.y = tf.compat.v1.layers.Dense(10,activation=None)(head)
